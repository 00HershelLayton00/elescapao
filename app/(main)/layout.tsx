    ...
    <div className="min-h-screen bg-[#F4ECE1] text-[#3D2B1F] font-serif">
      <nav className="bg-[#3a2310] bg-[url('/images/wood_pattern.png')] border-b-4 border-[#3D2B1F] p-4 shadow-xl sticky top-0 z-50">
        <div className="container mx-auto">
          ...
          {/* Mobile Menu - Use details/summary for no-JS fallback */}
          <div className="md:hidden">
            <details className="relative">
              <summary className="text-[#FFF8DC] p-2 focus:outline-none list-none cursor-pointer flex justify-end">
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M4 12h16m-7 6h7" />
                </svg>
              </summary>
              <div className="absolute right-0 top-14 w-48 bg-[#3a2310] bg-[url('/images/wood_pattern.png')] border-2 border-[#3D2B1F] shadow-2xl rounded-sm py-4 flex flex-col gap-4 z-[60]">
