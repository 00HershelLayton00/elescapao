        ...
        <div className="container mx-auto relative"> {/* Relative aquí es clave */}
          <div className="flex justify-between items-center">
            ...
            <button
              ...
              className="md:hidden text-[#FFF8DC] p-2 focus:outline-none transition-transform active:scale-90"
            >
            ...
            <div className="hidden md:flex gap-8 text-[#FFF8DC] font-bold uppercase text-xl tracking-wider">
          ...
          {isOpen && (
            <div className="absolute right-0 top-14 w-48 bg-[#3a2310] bg-[url('/images/wood_pattern.png')] 
              ...
              <Link
                ...
                className="text-[#FFF8DC] px-6 py-2 font-bold uppercase tracking-widest border-b border-[#FFF8DC]/10 hover:bg-black/20"
              >
                Menú
              </Link>
              <Link
              ...
              <Link
                href="/contacto"
                onClick={() => setIsOpen(false)}
                className="text-[#FFF8DC] px-6 py-2 font-bold uppercase tracking-widest hover:bg-black/20"
              >
                Contacto
              </Link>
            </div>
      ...
      <footer className="bg-[#1A120B] bg-[url('/images/wood_pattern.png')] text-[#FFF8DC] py-6 border-t-4 border-[#3D2B1F] mt-12">
        <div className="container mx-auto px-4 flex justify-between items-center">
          ...
          <a
            ...
            aria-label="Facebook del restaurante"
          >
            <svg
              className="w-8 h-8 fill-[#FFF8DC]"
              viewBox="0 0 24 24"
            >
          ...
          {/* Derecha: Nombre del Restaurante */}
