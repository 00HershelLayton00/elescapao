import Gallery from '../../component/Gallery'; // Ajusta la ruta según tu proyecto
  ...
  return (
    <main>
      ...
      <div className="relative flex flex-col justify-between pt-10 overflow-hidden bg-[#F4ECE1] bg-[url('/images/papel.png')] bg-repeat bg-blend-multiply">
        ...
        {/* Componente de Galería Extraído */}
        <Gallery />
      </div>
      ...
      <div className="bg-[#F4ECE1] bg-[url('/images/tela.jpg')] pt-24 border-y-2 border-[#3D2B1F]/10">
        ...
        <div className="container mx-auto px-4">
          <h2 className={`flex items-center justify-center gap-2 md:gap-4 text-4xl md:text-6xl font-black text-center mb-10 md:mb-16 ${pacifico.className} text-[#2C1E16]`}>
            <svg viewBox="0 0 24 24" fill="none" className="w-8 h-8 md:w-14 md:h-14 shrink-0">
        ...
        <div className="relative flex items-center justify-center w-full mt-16 mb-5">
          ...
          <div className="flex-shrink-0 mx-4 md:mx-6 text-[#8B6914] drop-shadow-md">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-utensils-crossed"><path d="m16 2-2.3 2.3a3 3 0 0 0 0 4.2l1.8 1.8a3 3 0 0 0 4.2 0L22 8" /><path d="M15 15 3.3 3.3a4.2 4.2 0 0 0 0 6l7.3 7.3c.7.7 2 .7 2.8 0L15 15Zm0 0 7 7" /><path d="m2.1 21.8 6.4-6.3" /><path d="m19 5-7 7" /></svg>
          </div>
