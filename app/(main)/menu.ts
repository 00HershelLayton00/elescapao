        ...
        subcategorias: [
            {
                nombre: "Entrantes",
                productos: [
                    { nombre: "Croquetas de pescado", desc: "", precio: "$3000" ,rating:3.9, icono: "🐟" },
                    { nombre: "Croquetas de Camarón", desc: "", precio: "$3000", icono: "🦐" },
                    { nombre: "Croqueta de Ahumada", desc: "", precio: "$3000", icono: "💨" },
                    { nombre: "Croqueta de Queso", desc: "", precio: "$3000", icono: "🧀" },
                    { nombre: "Brochetas de Cerdo", desc: "", precio: "$3800", icono: "🍢" },
                    { nombre: "Brochetas de Pollo", desc: "", precio: "$3800", icono: "🍗" },
                    { nombre: "Brochetas de vegetales", desc: "", precio: "$3800", icono: "🥦" },
                    ...
                    { nombre: "Picada Escapa", desc: "Bolita de queso, brocheta, masa frita, chorizo, Croquetas, pizza napolitana", precio: "Consultar", icono: "🍽️" }
                ]
            },
            {
                nombre: "Aperitivos",
