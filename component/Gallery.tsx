...
const FOTOS_GALERIA = [
    { id: 1, url: "/images/restaurante1.jpg", descripcion: "Momento #1" },
    { id: 2, url: "/images/restaurante2.jpg", descripcion: "Momento #2" },
    { id: 3, url: "/images/restaurante3.jpg", descripcion: "Momento #3" },
    { id: 4, url: "/images/restaurante4.jpg", descripcion: "Momento #4" },
    { id: 5, url: "/images/restaurante5.jpg", descripcion: "Momento #5" },
    { id: 6, url: "/images/restaurante6.jpg", descripcion: "Momento #6" },
    { id: 7, url: "/images/restaurante7.jpg", descripcion: "Momento #7" },
    { id: 8, url: "/images/restaurante8.jpg", descripcion: "Momento #8" },
];
                ...
                >
                    ...
                    >
                        {FOTOS_GALERIA.map((foto) => (
                            ...
                            >
                                {/* Marco de la foto tipo "Polaroid" rústica */}
                                <div className="bg-[#1A120B] p-4 pb-10 shadow-2xl rounded-sm transform transition-all duration-500 rotate-1 md:hover:rotate-0 hover:scale-[1.02] group">
                                    ...
                                    {/* Texto dinámico desde el objeto */}
                                    <div className="mt-4 text-center">
                                        <span className={`${pacifico.className} text-[#EBDCCB]/70 text-lg md:text-xl block`}>
                                            {foto.descripcion}
                                        </span>
                                    </div>
                                </div>
